  ...
  const addFavorite = () => {
    if (!userLogged) {
      ...
      db.collection("favorites")
        ...
        .then(() => {
          setIsFavorite(true);
          toastRef.current.show("Lugar añadido a la lista de favoritos");
        })
        .catch(() => {
          toastRef.current.show(
            "Error al añadir el lugar a la lista de favoritos, intentelo más tarde"
          );
        });
    }
  };
        ...
        response.forEach(doc => {
          ...
          db.collection("favorites")
            ...
            .then(() => {
              setIsFavorite(false);
              toastRef.current.show(
                "Lugar eliminado de la lista de favoritos"
              );
            })
            .catch(() => {
              toastRef.current.show(
...
function RestaurantInfo(props) {
  ...
  const listInfo = [
    ...
    {
      text: "soporte@fusagasuga_viajes.com",
      iconName: "at",
      iconType: "material-community",
      action: null
    }
